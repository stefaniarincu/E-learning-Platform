...
public class BiCameral extends Apartament{
    ...
    public Integer calcNrCamere() {
        return this.getUtilitati().getNrBai() + 3;
    }

    @Override
    public String toString() {
        if(getStatus().equals("vandut")) {
            return "APARTAMENT VANDUT --> TIP 2 CAMERE ---> Nr apartament: " + getNrApartament() + " //  Pret: " + getPret() + " //  Dimensiune: "
                    + getDimensiune() + " metrii patrati //  Data cumparare: " + getData() + " // Numar camere: " + calcNrCamere() + " "
                    + " // " + getUtilitati().toString() + "\n";
        }

        return "APARTAMENT INCHIRIAT --> TIP 2 CAMERE ---> Nr apartament: " + getNrApartament() + " //  Pret: " + getPret() + " //  Dimensiune: "
