...
public class Main {
    public static void main(String[] args) {
        ...
        List<Imobiliare> lImobiliare = List.of(
                new OpenSpace(10, 566.4, 50.5, LocalDate.of(2022,3,13), "vandut", new Imobiliare.Utilitati(1, 2, false, apart1)),
                new Duplex(24, 1200.0, 99.9, LocalDate.of(2022,2,22), "vandut", new Imobiliare.Utilitati(3, 5, true, apart2)),
                new Duplex(26, 1100.0, 98.9, LocalDate.of(2022,2,23), "vandut", new Imobiliare.Utilitati(3, 4, true, apart1)),
                new BiCameral(1, 709.0, 66.9, LocalDate.of(2023,2,22), "inchiriat", new Imobiliare.Utilitati(1, 1, true, apart1)),
                new BiCameral(11, 720.0, 75.9, LocalDate.of(2022,12,21), "inchiriat", new Imobiliare.Utilitati(2, 2, false, apart2))
               );
        System.out.println("\n-------------------INITIAL-------------------\n");
        System.out.println(lImobiliare);
        System.out.println("----------------------------------------------\n\n");
        lImobiliare = lImobiliare.stream().sorted().toList();
        ...
        for(Imobiliare imobil: lImobiliare) {
            if (imobil instanceof BiCameral) {
                ...
                if (imobil.getStatus().equals("vandut"))
                    StatisticaV.computeIfPresent("tricameral", (k, v) -> v + 1);
